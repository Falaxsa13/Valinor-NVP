...
const sampleKanbanTasks: Task[] = [
  {
    ...
    status: "To Do",
    priority: "High",
    assignee: "Hans Ibarra",
    dueDate: "2025-03-01",
    tags: ["team", "background", "networking"],
  },
  {
    id: 2,
    title: "Company",
    status: "To Do",
    priority: "High",
    assignee: "Mateo Rodriguez",
    dueDate: "2025-03-02",
    tags: ["business", "mission", "branding"],
  },
  {
    id: 3,
    title: "Progress",
    status: "To Do",
    priority: "High",
    assignee: "Luis Cusihuallpa",
    dueDate: "2025-03-03",
    tags: ["milestones", "growth", "traction"],
  },
  {
    id: 4,
    title: "Idea",
    ...
    assignee: "Hans Ibarra",
    dueDate: "2025-03-04",
    tags: ["innovation", "problem-solving", "strategy"],
  },
  {
    id: 5,
    title: "Equity",
